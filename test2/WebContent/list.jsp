...
<%@page import="Guitar.entity.*" %>
<%@page import="Guitar.dao.*" %>
<%@page import="Guitar.dao.impl.*" %>
...
<ul>
    ...
    <div id="form">
      <%
                                ...
                                String backwood=(String)request.getAttribute("backwood");
                                String topwood=(String)request.getAttribute("topwood");
